  ...
  public message
{
 ...
 public:
  ...
  /* typedef enum { */
  /*   null_netmsg_type=0, */
  /*   null_netmsg_type_pm=1,     */
  /*   rdma_get_request=2, */
  /*   rdma_get_request_pm=3, */
  /*   rdma_get_sent_ack=4, */
  /*   rdma_get_sent_ack_pm=5, */
  /*   rdma_get_nack=6, */
  /*   rdma_get_nack_pm=7, */
  /*   rdma_put_sent_ack=8, */
  /*   rdma_put_sent_ack_pm=9, */
  /*   rdma_put_nack=10, */
  /*   rdma_put_nack_pm=11, */
  /*   payload_sent_ack=12, */
  /*   payload_sent_ack_pm=13, */
  /*   payload=14, */
  /*   payload_pm=15, */
  /*   rdma_get_payload=16, */
  /*   rdma_get_payload_pm=17, */
  /*   rdma_put_payload=18, */
  /*   rdma_put_payload_pm=19, */
  /*   nvram_get_request=20, */
  /*   nvram_get_request_pm=21, */
  /*   nvram_get_payload=22, */
  /*   nvram_get_payload_pm=23, */
  /*   failure_notification=24, */
  /*   failure_notification_pm=25 */
  /* } type_t; */
 ...
 public:
  ...
  void set_pm_monitor(bool pm_mtr);
